...
function execHardfork(hardfork, preMergeHf) {
    return hardfork !== ethereumjs_common_1.Hardfork.Merge ? hardfork : preMergeHf;
}
/**
 * @ignore
 */
async function runTx(opts) {
    ...
    opts.block = opts.block ?? ethereumjs_block_1.Block.fromBlockData({}, { common: this._common });

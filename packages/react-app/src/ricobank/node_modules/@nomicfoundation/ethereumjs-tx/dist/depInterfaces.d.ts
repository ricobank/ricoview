...
export interface Kzg {
    ...
    verifyAggregateKzgProof(blobs: Uint8Array[], expectedKzgCommitments: Uint8Array[], kzgAggregatedProof: Uint8Array): boolean;
}
//# sourceMappingURL=depInterfaces.d.ts.map
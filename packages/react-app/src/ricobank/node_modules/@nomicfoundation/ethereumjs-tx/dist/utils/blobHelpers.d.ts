export declare const getBlobs: (input: string) => Buffer[];
/**
 ...
 */
export declare const commitmentsToVersionedHashes: (commitments: Buffer[]) => Buffer[];
//# sourceMappingURL=blobHelpers.d.ts.map
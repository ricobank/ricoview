...
class AccessListEIP2930Transaction extends baseTransaction_1.BaseTransaction {
    ...
    constructor(txData, opts = {}) {
        ...
        this.gasPrice = (0, ethereumjs_util_1.bufferToBigInt)((0, ethereumjs_util_1.toBuffer)(gasPrice === '' ? '0x' : gasPrice));
    ...
    static fromSerializedTx(serialized, opts = {}) {
        ...
        const values = (0, ethereumjs_util_1.arrToBufArr)(ethereumjs_rlp_1.RLP.decode(Uint8Array.from(serialized.slice(1))));

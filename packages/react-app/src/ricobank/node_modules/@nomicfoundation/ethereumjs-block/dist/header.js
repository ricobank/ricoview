...
class BlockHeader {
    ...
    constructor(headerData, options = {}) {
        ...
        const hardforkDefaults = {
            baseFeePerGas: this._common.isActivatedEIP(1559)
                ? number === this._common.hardforkBlock(ethereumjs_common_1.Hardfork.London)
                    ? this._common.param('gasConfig', 'initialBaseFee')
                    : BigInt(7)
                : undefined,
            withdrawalsRoot: this._common.isActivatedEIP(4895) ? ethereumjs_util_1.KECCAK256_RLP : undefined,
            excessDataGas: this._common.isActivatedEIP(4844) ? BigInt(0) : undefined,
        };
        const baseFeePerGas = (0, ethereumjs_util_1.toType)(headerData.baseFeePerGas, ethereumjs_util_1.TypeOutput.BigInt) ?? hardforkDefaults.baseFeePerGas;
        const withdrawalsRoot = (0, ethereumjs_util_1.toType)(headerData.withdrawalsRoot, ethereumjs_util_1.TypeOutput.Buffer) ?? hardforkDefaults.withdrawalsRoot;
        const excessDataGas = (0, ethereumjs_util_1.toType)(headerData.excessDataGas, ethereumjs_util_1.TypeOutput.BigInt) ?? hardforkDefaults.excessDataGas;
    ...
    raw() {
        ...
        if (this._common.isActivatedEIP(4844) === true) {
            rawItems.push((0, ethereumjs_util_1.bigIntToUnpaddedBuffer)(this.excessDataGas));
        }
        return rawItems;
    }
    /**
    ...
    toJSON() {
        ...
        if (this._common.isActivatedEIP(4844) === true) {
            jsonDict.excessDataGas = (0, ethereumjs_util_1.bigIntToHex)(this.excessDataGas);
        }
        return jsonDict;
    }
    /**

...
import type { AddressLike, BigIntLike, BufferLike, JsonRpcWithdrawal, WithdrawalBuffer, WithdrawalData } from '@nomicfoundation/ethereumjs-util';
/**
...
export declare type WithdrawalsBuffer = WithdrawalBuffer[];
export declare type BlockBuffer = [BlockHeaderBuffer, TransactionsBuffer, UncleHeadersBuffer] | [BlockHeaderBuffer, TransactionsBuffer, UncleHeadersBuffer, WithdrawalsBuffer];
export declare type BlockHeaderBuffer = Buffer[];
export declare type BlockBodyBuffer = [TransactionsBuffer, UncleHeadersBuffer, WithdrawalsBuffer?];
/**

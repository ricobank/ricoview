...
class Blockchain {
    ...
    constructor(opts = {}) {
        ...
        this._heads = {};
        this._lock = new ethereumjs_util_1.Lock();
    ...
    createGenesisBlock(stateRoot) {
        ...
        common.setHardforkByBlockNumber(0, BigInt(common.genesis().difficulty), common.genesis().timestamp);
        const header = {
            ...common.genesis(),
            number: 0,
            stateRoot,
            withdrawalsRoot: common.isActivatedEIP(4895) ? ethereumjs_util_1.KECCAK256_RLP : undefined,
        ...
        return ethereumjs_block_1.Block.fromBlockData({ header, withdrawals: common.isActivatedEIP(4895) ? [] : undefined }, { common });
    }
    /**

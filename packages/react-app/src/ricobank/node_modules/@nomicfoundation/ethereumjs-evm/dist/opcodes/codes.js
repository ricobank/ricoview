...
const hardforkOpcodes = [
    {
        hardfork: ethereumjs_common_1.Hardfork.Homestead,
        opcodes: {
            0xf4: { name: 'DELEGATECALL', isAsync: true, dynamicGas: true }, // EIP 7
        },
    },
    {
        hardfork: ethereumjs_common_1.Hardfork.TangerineWhistle,
        opcodes: {
            0x54: { name: 'SLOAD', isAsync: true, dynamicGas: true },
            0xf1: { name: 'CALL', isAsync: true, dynamicGas: true },
            0xf2: { name: 'CALLCODE', isAsync: true, dynamicGas: true },
    ...
    {
        hardfork: ethereumjs_common_1.Hardfork.Byzantium,
        opcodes: {
    ...
    {
        hardfork: ethereumjs_common_1.Hardfork.Constantinople,
        opcodes: {
    ...
    {
        hardfork: ethereumjs_common_1.Hardfork.Istanbul,
        opcodes: {

...
exports.handlers = new Map([
    ...
    [
        ...
        function (runState) {
            ...
            const r = (0, util_1.mod)(a + b, ethereumjs_util_1.TWO_POW256);
    ...
    [
        ...
        function (runState) {
            ...
            if (b === BigInt(0)) {
                ...
                r = (0, util_1.mod)(a / b, ethereumjs_util_1.TWO_POW256);
            }
            runState.stack.push(r);
        },
    ],
    ...
    [
        ...
        function (runState) {
            ...
            if (b === BigInt(0)) {
                ...
                r = (0, util_1.toTwos)((0, util_1.fromTwos)(a) / (0, util_1.fromTwos)(b));
            }
            runState.stack.push(r);
        },
    ],
    ...
    [
        ...
        function (runState) {
            ...
            if (b === BigInt(0)) {
                ...
                r = (0, util_1.fromTwos)(a) % (0, util_1.fromTwos)(b);
            }
            runState.stack.push((0, util_1.toTwos)(r));
        },
    ],
    // 0x08: ADDMOD
    [
    ...
    [
        ...
        function (runState) {
            const [a, b] = runState.stack.popN(2);
            const r = (0, util_1.fromTwos)(a) < (0, util_1.fromTwos)(b) ? BigInt(1) : BigInt(0);
            runState.stack.push(r);
        },
    ],
    // 0x13: SGT
    ...
    [
        0x30,
        function (runState) {
            const address = (0, ethereumjs_util_1.bufferToBigInt)(runState.interpreter.getAddress().buf);
    ...
    [
        ...
        function (runState) {
            ...
            let r = (0, ethereumjs_util_1.bufferToBigInt)(loaded);
            if (loaded.length < 32) {
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const data = (0, util_1.getDataSlice)(runState.interpreter.getCallData(), dataOffset, dataLength);
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const data = (0, util_1.getDataSlice)(runState.interpreter.getCode(), codeOffset, dataLength);
                const memOffsetNum = Number(memOffset);
    ...
    [
        ...
        async function (runState) {
            const addressBigInt = runState.stack.pop();
            const size = BigInt((await runState.eei.getContractCode(new ethereumjs_util_1.Address((0, util_1.addressToBuffer)(addressBigInt)))).length);
    ...
    [
        ...
        async function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const code = await runState.eei.getContractCode(new ethereumjs_util_1.Address((0, util_1.addressToBuffer)(addressBigInt)));
    ...
    [
        ...
        function (runState) {
            ...
            if (dataLength !== BigInt(0)) {
                const data = (0, util_1.getDataSlice)(runState.interpreter.getReturnData(), returnDataOffset, dataLength);
                const memOffsetNum = Number(memOffset);
                const lengthNum = Number(dataLength);
                runState.memory.write(memOffsetNum, lengthNum, data);
            }
    ...
    [
        ...
        function (runState) {
            ...
            runState.stack.push((0, ethereumjs_util_1.bufferToBigInt)(word));
        },
    ],
    // 0x52: MSTORE
    [
        ...
        function (runState) {
            ...
            const buf = (0, ethereumjs_util_1.setLengthLeft)((0, ethereumjs_util_1.bigIntToBuffer)(word), 32);
    ...
    [
        ...
        function (runState) {
            ...
            const buf = (0, ethereumjs_util_1.bigIntToBuffer)(byte & BigInt(0xff));
            const offsetNum = Number(offset);
    ...
    [
        ...
        async function (runState) {
            ...
            const valueBigInt = value.length ? (0, ethereumjs_util_1.bufferToBigInt)(value) : BigInt(0);
    ...
    [
        ...
        function (runState, common) {
            if (common.isActivatedEIP(2315)) {
                ...
                // TLOAD
                const key = runState.stack.pop();
                const keyBuf = (0, ethereumjs_util_1.setLengthLeft)((0, ethereumjs_util_1.arrToBufArr)((0, ethereumjs_util_1.bigIntToBytes)(key)), 32);
                const value = runState.interpreter.transientStorageLoad(keyBuf);
                const valueBN = value.length ? (0, ethereumjs_util_1.bytesToBigInt)(value) : BigInt(0);
    ...
    [
        ...
        function (runState, common) {
            if (common.isActivatedEIP(2315)) {
                ...
                runState.interpreter.transientStorageStore(keyBuf, (0, ethereumjs_util_1.arrToBufArr)(value));
            }
        },
    ],
    // 0x5e: JUMPSUB
    ...
    [
        ...
        function (runState) {
            ...
            const topicsBuf = topics.map(function (a) {
                return (0, ethereumjs_util_1.setLengthLeft)((0, ethereumjs_util_1.bigIntToBuffer)(a), 32);
            });
    ...
    [
        ...
        async function (runState) {
            ...
            const ret = await runState.interpreter.create2(gasLimit, value, data, (0, ethereumjs_util_1.setLengthLeft)((0, ethereumjs_util_1.bigIntToBuffer)(salt), 32));
            runState.stack.push(ret);
        },
    ],
    // 0xf1: CALL
    ...
    [
        ...
        async function (runState) {
            ...
            if ((0, ethereumjs_util_1.bufferToBigInt)(s) > ethereumjs_util_1.SECP256K1_ORDER_DIV_2) {
                (0, util_1.trap)(exceptions_1.ERROR.AUTH_INVALID_S);
            }
            const paddedInvokerAddress = (0, ethereumjs_util_1.setLengthLeft)(runState.interpreter._env.address.buf, 32);
            const chainId = (0, ethereumjs_util_1.setLengthLeft)((0, ethereumjs_util_1.bigIntToBuffer)(runState.interpreter.getChainId()), 32);
            ...
            let recover;
            try {
                recover = (0, ethereumjs_util_1.ecrecover)(msgHash, yParity + BigInt(27), r, s);
            }
            catch (e) {
            ...
            const expectedAddress = new ethereumjs_util_1.Address((0, ethereumjs_util_1.setLengthLeft)((0, ethereumjs_util_1.bigIntToBuffer)(authority), 20));
    ...
    [
        ...
        async function (runState) {
            ...
            // Write return data to memory
            (0, util_1.writeCallOutput)(runState, retOffset, retLength);
            runState.stack.push(ret);
        },
    ],
    // 0xfa: STATICCALL

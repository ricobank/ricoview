...
import type { HashKeysFunction, Nibbles } from '../types';
/**
 ...
 */
export declare function verifyRangeProof(rootHash: Buffer, firstKey: Nibbles | null, lastKey: Nibbles | null, keys: Nibbles[], values: Buffer[], proof: Buffer[] | null, useKeyHashingFunction: HashKeysFunction): Promise<boolean>;

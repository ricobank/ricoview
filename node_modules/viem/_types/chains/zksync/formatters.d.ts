...
export declare const formatters: {
    readonly block: {
        exclude: [] | undefined;
        format: (args: import("../index.js").Assign<Partial<import("../../index.js").RpcBlock>, ZkSyncRpcBlockOverrides & {
    ...
    readonly transactionReceipt: {
        exclude: [] | undefined;
        format: (args: import("../index.js").Assign<Partial<import("../../index.js").RpcTransactionReceipt>, ZkSyncRpcTransactionReceiptOverrides>) => {
            blockHash: `0x${string}`;
            blockNumber: bigint;

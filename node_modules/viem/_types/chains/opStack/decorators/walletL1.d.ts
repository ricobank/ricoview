...
import { type DepositTransactionParameters, type DepositTransactionReturnType } from '../actions/depositTransaction.js';
import { type FinalizeWithdrawalParameters, type FinalizeWithdrawalReturnType } from '../actions/finalizeWithdrawal.js';
import { type ProveWithdrawalParameters, type ProveWithdrawalReturnType } from '../actions/proveWithdrawal.js';
export type WalletActionsL1<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     * })
     */
    depositTransaction: <chainOverride extends Chain | undefined = undefined>(parameters: DepositTransactionParameters<chain, account, chainOverride>) => Promise<DepositTransactionReturnType>;
    /**
     ...
     * })
     */
    finalizeWithdrawal: <chainOverride extends Chain | undefined = undefined>(parameters: FinalizeWithdrawalParameters<chain, account, chainOverride>) => Promise<FinalizeWithdrawalReturnType>;
    /**

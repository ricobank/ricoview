...
import { type BuildInitiateWithdrawalParameters, type BuildInitiateWithdrawalReturnType } from '../actions/buildInitiateWithdrawal.js';
...
export type PublicActionsL1<chain extends Chain | undefined = Chain | undefined, account extends Account | undefined = Account | undefined> = {
     ...
     * })
     */
    buildInitiateWithdrawal: <chainOverride extends Chain | undefined = undefined, accountOverride extends Account | Address | undefined = undefined>(parameters: BuildInitiateWithdrawalParameters<chain, account, chainOverride, accountOverride>) => Promise<BuildInitiateWithdrawalReturnType<account, accountOverride>>;
    /**
     ...
     * })
     */
    estimateDepositTransactionGas: <chainOverride extends Chain | undefined = undefined>(parameters: EstimateDepositTransactionGasParameters<chain, account, chainOverride>) => Promise<EstimateDepositTransactionGasReturnType>;
    /**
 ...
 * }).extend(publicActionsL1())
 */
export declare function publicActionsL1(): <TTransport extends Transport, TChain extends Chain | undefined = Chain | undefined, TAccount extends Account | undefined = Account | undefined>(client: Client<TTransport, TChain, TAccount>) => PublicActionsL1<TChain, TAccount>;

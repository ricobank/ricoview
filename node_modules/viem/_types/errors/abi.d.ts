...
export type AbiDecodingOffsetOutOfBoundsErrorType = AbiDecodingOffsetOutOfBoundsError & {
    name: 'AbiDecodingOffsetOutOfBoundsError';
};
export declare class AbiDecodingOffsetOutOfBoundsError extends BaseError {
    name: string;

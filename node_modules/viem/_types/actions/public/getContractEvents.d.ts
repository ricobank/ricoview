 ...
 * })
 */
export declare function getContractEvents<chain extends Chain | undefined, const abi extends Abi | readonly unknown[], eventName extends ContractEventName<abi> | undefined = undefined, TStrict extends boolean | undefined = undefined, TFromBlock extends BlockNumber | BlockTag | undefined = undefined, TToBlock extends BlockNumber | BlockTag | undefined = undefined>(client: Client<Transport, chain>, parameters: GetContractEventsParameters<abi, eventName, TStrict, TFromBlock, TToBlock>): Promise<GetContractEventsReturnType<abi, eventName, TStrict, TFromBlock, TToBlock>>;

 ...
 */
export declare function getEnsAvatar<TChain extends Chain | undefined>(client: Client<Transport, TChain>, { blockNumber, blockTag, assetGatewayUrls, name, gatewayUrls, strict, universalResolverAddress, }: GetEnsAvatarParameters): Promise<GetEnsAvatarReturnType>;

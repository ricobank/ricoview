...
import { type ContractFunctionArgs, type ContractFunctionName } from '../../types/contract.js';
...
export type WalletActions<TChain extends Chain | undefined = Chain | undefined, TAccount extends Account | undefined = Account | undefined> = {
     ...
     * const signature = await client.signTransaction(request)
     */
    signTransaction: <TChainOverride extends Chain | undefined>(args: SignTransactionParameters<TChain, TAccount, TChainOverride>) => Promise<SignTransactionReturnType>;
    /**

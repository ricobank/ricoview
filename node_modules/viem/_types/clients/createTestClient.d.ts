...
export type TestClient<TMode extends TestClientMode = TestClientMode, transport extends Transport = Transport, chain extends Chain | undefined = Chain | undefined, TAccount extends Account | undefined = Account | undefined, TIncludeActions extends boolean = true> = Prettify<{
    mode: TMode;
} & Client<transport, chain, TAccount, TestRpcSchema<TMode>, TIncludeActions extends true ? TestActions : Record<string, unknown>>>;
...
transport extends Transport, chain extends Chain | undefined = undefined, accountOrAddress extends Account | Address | undefined = undefined>(parameters: TestClientConfig<mode, transport, chain, accountOrAddress>): TestClient<mode, transport, chain, ParseAccount<accountOrAddress>>;

...
export type Chain<formatters extends ChainFormatters | undefined = ChainFormatters | undefined> = {
...
export type ExtractChain<chains extends readonly Chain[], chainId extends Chain['id']> = Extract<chains[number], {
    id: chainId;
}>;
...
export type ExtractChainFormatterReturnType<chain extends Chain | undefined, type extends keyof ChainFormatters, fallback> = chain extends {
    formatters?: {
        [_ in type]?: infer formatter extends ChainFormatter;
    } | undefined;
} ? chain['formatters'] extends undefined ? fallback : ReturnType<formatter['format']> : fallback;

...
export type OneOf<union extends object, keys extends KeyofUnion<union> = KeyofUnion<union>> = union extends infer Item ? Prettify<Item & {
    [_K in Exclude<keys, keyof Item>]?: undefined;
}> : never;
